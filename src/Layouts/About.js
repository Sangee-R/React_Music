...
function About({ uiState, setUiState }) {
    ...
    let answerTwo =
        "This project was created by Sangeetha. A Computer Applications student, developer, and designer who likes creating awesome things that live on the internet! If you like what you just saw and would like to see more, then scroll below to check his socials!";
    ...
    return (
        <div className={`about ${uiState.aboutShown ? "" : "about--hidden"}`}>
            ...
            <div className="about__wrapper">
                ...
                <div className="about-group">
                    <p>Sangeetha's</p>
                    <AboutHeadline content="Social Media" />
                </div>
